...
set output '| epstopdf --filter --outfile=bank-3d-a32768.pdf'
...
splot 'bankall/clock-numa-a32768.data' using 2:1:($3/1000000) with lines title "Numa", \
      'bankall/clock-thread-a32768.data' using 2:1:($3/1000000) with lines title "DAP", \
      'bankall/tinystm-a32768.data' using 2:1:($3/1000000) with lines title "TinySTM"
