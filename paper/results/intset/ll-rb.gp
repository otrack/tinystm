...
plot "ll-global.log" u  3:xtic(2) ls 1 title "Global Clock",\
     "ll-global_async.log" u 3:xtic(2) ls 3 title "Thread Clock"
...
#set yrange [0:90]
unset ylabel
plot "rb_global_100k.log" u  3:xtic(2) ls 1 title "Global Clock",\
     "rb-global_async.log" u  3:xtic(2) ls 3 title "Thread" 
