...
set output '| epstopdf --filter --outfile=bank-3d-a65536.pdf'
...
splot 'bankall/clock-numa-a65536.data' using 2:1:($3/1000000) with lines title "Numa", \
      'bankall/clock-thread-a65536.data' using 2:1:($3/1000000) with lines title "DAP", \
      'bankall/tinystm-a65536.data' using 2:1:($3/1000000) with lines title "TinySTM"
