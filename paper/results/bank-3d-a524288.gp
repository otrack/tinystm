...
set output '| epstopdf --filter --outfile=bank-3d-a524288.pdf'
...
splot 'bankall/clock-numa-a524288.data' using 2:1:($3/1000000) with lines title "Numa", \
      'bankall/clock-thread-a524288.data' using 2:1:($3/1000000) with lines title "DAP", \
      'bankall/tinystm-a524288.data' using 2:1:($3/1000000) with lines title "TinySTM"
