...
In this case, a read-only transaction alayws sees a strictly consistent snapshot.
...
This implies that the calls to process clocks (at \reflinestwo{stm:start:1}{stm:commit:2}) are strictly speaking unecessary and can be skipped without impacting the correctness of \refalg{stm}.
