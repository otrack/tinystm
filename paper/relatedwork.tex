...
The complexity of such an approach is quadratic in the number of objects read along the execution path.
...
Clock contention~\cite{6121290} is one of the them.
To avoid this problem, workloads as well as TM designs should be more parallel \cite{Nguyen:2017}.
