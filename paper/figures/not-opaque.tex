\begin{figure}[!h]
  ...
  \begin{tikzpicture}[scale=0.77]
    ...
    \path[->] (0.5,1) edge (11,1);
    \path[->] (0.5,1.8) edge (11,1.8);
    ...
    \path[callA] (7,1.8) edge (9,1.8);
    \path[callA,->] (7,2) edge (7,1.8);
    \path[callA,->] (9,1.8) edge (9,2);
    \node at (7,2.2) {$\stmTryCommitFunction()$};
    \node at (9,2.2) {$\flagAbort$};
    ...
    \path[callB] (7,1) edge (9,1);
    \path[callB,->] (7,1.2) edge (7,1.2);
    \path[callB,->] (9,1) edge (9,1.2);
    \node at (7,1.4) {$\stmTryCommitFunction()$};
    \node at (9,1.4) {$\flagCommit$};
    
    \pgfresetboundingbox
    \clip[use as bounding box] (0,.7) rectangle (11,2);
  \end{tikzpicture}
\end{figure}
