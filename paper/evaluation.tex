...
As shown in ~\reffigure{bank:speedup}, our TM implementation leverages the presence of data locality.
...
In \reffigure{llrb}, we observe that \textsc{TinyStm} outperforms our implementation in the linked-list benchmark.
