...
set output '| epstopdf --filter --outfile=bank-3d-a16384.pdf'
...
splot 'bankall/clock-numa-a16384.data' using 2:1:($3/1000000) with lines title "Numa", \
      'bankall/clock-thread-a16384.data' using 2:1:($3/1000000) with lines title "DAP", \
      'bankall/tinystm-a16384.data' using 2:1:($3/1000000) with lines title "TinySTM"
