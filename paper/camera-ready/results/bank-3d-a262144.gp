...
set output '| epstopdf --filter --outfile=bank-3d-a262144.pdf'
...
splot 'bankall/clock-numa-a262144.data' using 2:1:($3/1000000) with lines title "Numa", \
      'bankall/clock-thread-a262144.data' using 2:1:($3/1000000) with lines title "DAP", \
      'bankall/tinystm-a262144.data' using 2:1:($3/1000000) with lines title "TinySTM"
