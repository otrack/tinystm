...
set output '| epstopdf --filter --outfile=bank-3d-a8192.pdf'
...
splot 'bankall/clock-numa-a8192.data' using 2:1:($3/1000000) with lines title "Numa", \
      'bankall/clock-thread-a8192.data' using 2:1:($3/1000000) with lines title "DAP", \
      'bankall/tinystm-a8192.data' using 2:1:($3/1000000) with lines title "TinySTM"
