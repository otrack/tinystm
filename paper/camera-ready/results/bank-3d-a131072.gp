...
set output '| epstopdf --filter --outfile=bank-3d-a131072.pdf'
...
splot 'bankall/clock-numa-a131072.data' using 2:1:($3/1000000) with lines title "Numa", \
      'bankall/clock-thread-a131072.data' using 2:1:($3/1000000) with lines title "DAP", \
      'bankall/tinystm-a131072.data' using 2:1:($3/1000000) with lines title "TinySTM"
